                ...
                <main>
                    <div class="container-fluid px-4">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <a class="btn btn-success my-2" href="create_jenis_produk.php" role="button">Tambah Data</a>
                                ...
                                <thead class="table-primary">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                        ...
                                        <a class="btn btn-success" href="view_jenis_produk.php?id=<?=$row['id']?>">View</a>
                                        <a class="btn btn-warning" href="edit_jenis_produk.php?idedit=<?=$row['id']?>">Edit</a>
                                        <a class="btn btn-danger" href="delete_jenis_produk.php?delete=<?=$row['id']?>"
                                        onclick="if(!confirm('Anda Yakin Hapus Data Jenis Produk <?=$row['id']?>?')) {return false}"
                                        >Delete</a>
                                        </td>
                                       </tr>
                                       <?php
